Pod::Spec.new do |s|
  s.name     = 'ios-SVPullToRefresh'
  s.version  = '0.4.1'
  s.platform = :ios, '5.0'
  s.license  = 'MIT'
  s.summary  = 'Give pull-to-refresh to any UIScrollView with 1 line of code.'
  s.homepage = 'https://github.com/brivio/ios-SVPullToRefresh'
  s.source   = { :git => 'https://github.com/brivio/ios-SVPullToRefresh.git', :tag => s.version.to_s }
